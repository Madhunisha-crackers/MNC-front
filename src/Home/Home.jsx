    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      {promocode && !copiedPromos.includes(promocode.code) && (
        <motion.div
          ...
          className="absolute pointer-events-auto bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 text-white mobile:px-4 mobile:py-3 px-6 py-4 rounded-3xl shadow-2xl font-bold mobile:text-base text-lg border border-white/20 backdrop-blur-xl"
          style={{
            left: burstPosition.x,
            top: burstPosition.y,
            transform: "translate(-50%, -50%)",
        ...
        >
          <div className="flex items-center mobile:gap-2 gap-3">
            ...
            <div className="text-center">
              ...
              <div className="bg-white text-purple-700 px-3 py-1 rounded-full mobile:text-xs text-sm font-bold mt-1">
        ...
        >
          {showCloseButton && (
            <motion.button
              ...
              className="fixed mobile:top-24 mobile:right-4 hundred:mt-3 tab:mt-3 tab:h-14 tab:w-14 top-8 right-8 z-50 pointer-events-auto mobile:w-10 mobile:h-10 w-12 h-12 bg-red-500/90 hover:bg-red-600 backdrop-blur-xl text-white rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 border border-white/10"
              style={{
          ...
          {animationComplete && (
            ...
            >
              <motion.button
                ...
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold mobile:px-4 mobile:py-2 px-8 py-4 rounded-2xl shadow-2xl shadow-orange-500/30 flex items-center mobile:gap-2 gap-3 mobile:text-sm text-lg"
              >
...
const ModernCarousel = ({ media }) => {
  ...
  if (!mediaItems || mediaItems.length === 0) {
    return (
      <div className="w-full h-64 rounded-3xl mb-6 overflow-hidden bg-gray-50 flex items-center justify-center border border-orange-100">
        <div className="text-center">
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gray-50 border border-orange-100" />
      ...
      {mediaItems.length > 1 && (
        <>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={handlePrev}
            className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-black/40 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-black/60 border border-white/10"
          >
            <FaArrowLeft className="text-orange-400 text-lg" />
          </motion.button>
          <motion.button
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            onClick={handleNext}
            className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-black/40 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-black/60 border border-white/10"
          >
            ...
            {mediaItems.map((_, index) => (
              <motion.button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 ${
                  index === currentIndex ? "bg-white shadow-lg" : "bg-white/40 hover:bg-white/70"
                }`}
              />
            ))}
          </div>
...
function ModernStatCard({ icon: Icon, value, label, suffix, delay }) {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-500 border border-orange-100 hover:border-orange-300 overflow-hidden"
    >
      ...
      <div className="relative z-10 text-center">
        <div className="w-16 h-16 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-lg shadow-orange-500/30 group-hover:scale-110 transition-transform duration-500">
        ...
        <motion.div
          ...
          className="mb-2"
        >
          <span className="text-4xl font-bold text-orange-600 tabular-nums">{count}</span>
          <span className="text-2xl font-bold text-orange-600">{suffix}</span>
        </motion.div>
        <p className="text-black font-medium text-sm leading-relaxed">{label}</p>
      </div>
      <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-gradient-to-br from-orange-100 to-orange-200/50 rounded-full opacity-40 group-hover:scale-150 transition-transform duration-700" />
    </motion.div>
  )
}
    ...
    >
      ...
      >
        ...
        >
          <motion.button
            ...
            className="relative mobile:-translate-y-16 bg-gradient-to-r from-orange-500 via-red-500 to-purple-600 shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 overflow-hidden border-4 border-black/40 rounded-full"
            style={{
          ...
          >
            ...
            <div className="absolute mobile:-bottom-10 -bottom-12 left-1/2 -translate-x-1/2 bg-gradient-to-r from-green-500 via-blue-500 to-purple-600 text-white mobile:px-3 mobile:py-1 px-6 py-2 rounded-full mobile:text-xs text-sm font-bold whitespace-nowrap shadow-xl border border-white/20">
              <motion.div
                animate={{
                  rotate: 360,
                  scale: [1, 1.2, 1],
        ...
        {showDetailsModal && selectedProduct && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto border border-orange-100"
            >
              <div className="p-8 text-black">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-black mb-2">{selectedProduct.productname}</h2>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    onClick={handleCloseDetails}
                    className="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center transition-colors border border-gray-200"
                  >
                ...
                <div className="space-y-4">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-4 rounded-2xl transition-all duration-300 shadow-lg shadow-orange-500/30 hover:shadow-xl"
                  >
                    Enquire Now
                  </motion.button>
                </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="relative mobile:h-[180px] hundred:mt-10 onefifty:mt-5 onefifty:h-[400px] tab:h-[250px] mobile:-mt-25 hundred:h-[500px] rounded-3xl overflow-hidden shadow-2xl border border-white/10">
            <AnimatePresence mode="wait">
              {banners.map(
                (banner, idx) =>
                  currentSlide === idx && (
                ...
                {banners.map((_, idx) => (
                  <motion.button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      currentSlide === idx ? "bg-white shadow-lg" : "bg-white/40 hover:bg-white/70"
                    }`}
                  />
                ))}
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 mobile:-mt-20">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-red-500 mb-4">Fast Running Products</h2>
          ...
          <div className="relative">
            <div className="flex overflow-x-auto space-x-6 pb-4 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-orange-500 scrollbar-track-white/5">
              {fastRunningProducts.map((product, index) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    whileHover={{ y: -8, scale: 1.02 }}
                    className="group bg-white rounded-3xl shadow-lg hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-500 border border-orange-100 hover:border-orange-300 min-w-[300px] max-w-[300px] snap-center"
                  >
                    <div className="relative">
                      ...
                      <motion.button
                        ...
                        className="absolute top-4 right-4 w-10 h-10 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center shadow-md hover:bg-white transition-all duration-300 border border-orange-100"
                      >
                        <FaInfoCircle className="text-orange-500" />
                      </motion.button>
                    </div>
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-orange-600 mb-3 line-clamp-2 group-hover:text-orange-700 transition-colors">
                        {product.productname}
                      </h3>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={() => navigate("/price-list")}
                        className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-3 rounded-2xl transition-all duration-300 shadow-lg shadow-orange-500/30 hover:shadow-xl flex items-center justify-center gap-2"
                      >
                        Enquire Now
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-orange-500/30 to-orange-600/10 rounded-3xl opacity-50 -z-10" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <div className="space-y-6 text-lg text-black leading-relaxed">
                ...
                <h4 className="text-orange-400 inline-flex items-center gap-1"><AlertTriangle />We don't usually support online shopping, Every products displayed here are for your references...</h4>
              </div>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate("/about-us")}
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold px-8 py-4 rounded-2xl transition-all duration-300 shadow-lg shadow-orange-500/30 hover:shadow-xl flex items-center gap-3"
              >
                Learn More About Us
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-orange-500 mb-4">Our Categories</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full mx-auto mb-6" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map(({ name, icon: Icon, description }, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -8, scale: 1.02 }}
                className="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-500 border border-orange-100 hover:border-orange-300 text-center"
              >
                <div className="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-lg shadow-orange-500/30 group-hover:scale-110 transition-transform duration-500">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigate("/price-list")}
                  className="bg-orange-50 hover:bg-orange-600 hover:text-white text-orange-600 font-semibold px-6 py-3 rounded-2xl transition-all duration-300 border border-orange-100 hover:border-transparent flex items-center gap-2 mx-auto"
                >
                  Explore
                  <ArrowRight className="w-4 h-4" />
                </motion.button>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold text-black mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-700">Light Up Your</span> Celebrations
            </h2>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate("/price-list")}
              className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-400 hover:to-orange-500 text-white font-bold px-12 py-4 rounded-2xl text-lg transition-all duration-300 shadow-2xl shadow-orange-500/30 hover:shadow-orange-500/50 flex items-center gap-3 mx-auto"
            >
              Place Your Order
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-orange-600 mb-4">Our Achievements</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full mx-auto mb-6" />
            <p className="text-black text-lg max-w-2xl mx-auto">
      ...
      <footer className="bg-gradient-to-br from-gray-50 to-orange-50 text-black py-16 border-t border-orange-100 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto mobile:mb-5">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold mb-6 text-orange-600">Madhu Nisha Crackers</h3>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold mb-6 text-orange-600">Contact Info</h3>
              <div className="space-y-4 text-gray-700">
                ...
                <div>
                  ...
                  <a href="tel:+919487594689" className="text-gray-700 hover:text-orange-600 transition-colors block">
                    +91 94875 94689
                  </a>
                </div>
                <div>
                ...
                {navLinks.map((link) => (
                  <li key={link}>
                    <a
                      ...
                      className="text-gray-700 hover:text-orange-600 transition-colors duration-300 font-medium flex items-center gap-2 group"
                    >
          ...
          <div className="border-t border-orange-100 pt-8">
            <div className="text-center text-gray-600">
              ...
              <p>
                Copyright © 2025 <span className="text-orange-600 font-semibold">Madhu Nisha Crackers</span>. All rights
                reserved. Developed by <span className="text-orange-600 font-semibold">SPD Solutions</span>
              </p>
            </div>
          </div>
        </div>
