  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3 className="text-2xl font-bold text-orange-400 mb-4 group-hover:text-orange-600 transition-colors duration-500">
          {title}
        </h3>
  ...
  return (
    <div className="min-h-screen bg-white text-black overflow-x-hidden">
      ...
      <div className="relative z-10 mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="space-y-6 text-lg text-black leading-relaxed"
              >
                <p>
        ...
        {/* CTA Section */}
        <section className="py-20 mx-4 rounded-3xl overflow-hidden relative bg-gradient-to-br from-white to-orange-50 border border-orange-100 shadow-xl">
          <div className="absolute inset-0 bg-[url('/fireworks-pattern.png')] bg-cover bg-center opacity-5" />
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="relative z-10 max-w-4xl mx-auto text-center px-6 text-black"
          >
            <motion.div
              initial={{ scale: 0 }}
              whileInView={{ scale: 1 }}
              transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
              className="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-8 shadow-md"
            >
              <Sparkles className="w-10 h-10 text-white" />
            </motion.div>

            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-700">
              🎆 Premium Fireworks with Exclusive Discounts!
            </h2>

            <p className="text-xl mb-4 text-orange-800">
              Celebrate every occasion with <span className="font-semibold text-orange-600">Madhu Nisha Crackers</span>. Your
        ...
        <section className="py-32 px-4 md:px-8 relative">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-orange-600 mb-4">Our Foundation</h2>
              <div className="w-24 h-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full mx-auto mb-6" />
              <p className="text-orange-500 text-lg max-w-2xl mx-auto">
