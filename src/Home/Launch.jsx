  ...
  return (
    ...
    >
      ...
      {[
        ...
        <g key={`f${i}`}>
          <rect x={x} y={y} width={w} height={h} fill="#ffe8cc" />
          {/* Simple window grid */}
          {Array.from({ length: Math.floor(h / 22) }, (_, r) =>
            Array.from({ length: Math.floor(w / 16) }, (_, c) => (
              <rect key={`${r}${c}`}
                ...
                width={7} height={10}
                fill={(r + c) % 4 === 0 ? (lit ? "#ffd8a8" : "#fff8e0") : "#ffe8cc"}
                opacity={lit ? 0.9 : 0.5}
              />
            ))
          )}
      ...
      {[
        ...
        <g key={`n${i}`}>
          <rect x={x} y={y} width={w} height={h} fill="#ffd8a8" />
          {i % 4 === 0 && (
            <>
              <line x1={x+w/2} y1={y} x2={x+w/2} y2={y-16} stroke="#ffa94d" strokeWidth="1.5"/>
              <circle cx={x+w/2} cy={y-18} r="2" fill={lit ? "#ff3300" : "#ccc"}
          ...
          {Array.from({ length: Math.floor(h / 26) }, (_, r) =>
            Array.from({ length: Math.floor(w / 20) }, (_, c) => (
              <rect key={`${r}${c}`}
                ...
                width={9} height={13}
                fill={(r * 2 + c) % 5 === 0 ? (lit ? "#ff922b" : "#ffd8a8") : "#ffd8a8"}
      ...
      {/* Ground strip */}
      <rect x="0" y="310" width="1440" height="10" fill="#ffa94d" />
      <line x1="0" y1="310" x2="1440" y2="310" stroke="#ffd8a8" strokeWidth="1" />
    </svg>
  )
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ height:1.5, background:"#f0f0f0", position:"relative", overflow:"hidden" }}>
          <div style={{
            height:"100%",
            width:`${progress}%`,
