...
const ContactCard = ({ icon: Icon, title, content, delay = 0, gradient }) => {
  return (
    ...
    >
      ...
      <div className="relative pt-10 p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100 hover:border-orange-300 overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-xl font-bold text-black mb-6 text-center group-hover:text-orange-600 transition-colors duration-500">
            {title}
          </h2>
          <div className="space-y-3">
            {content.map((item, itemIndex) => (
              <div key={itemIndex}>
                {typeof item === "string" ? (
                  <p className="text-gray-700 text-center leading-relaxed group-hover:text-gray-600 transition-colors duration-500">
                    {item}
                  </p>
                ) : (
                  <motion.a
        ...
        <section className="max-w-7xl mx-auto pt-32 pb-16 px-6">
          ...
          >
            <motion.div
              ...
              className="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg shadow-orange-500/30"
            >
          ...
          >
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.6 }}
              viewport={{ once: true }}
              className="bg-white rounded-3xl shadow-xl p-10 max-w-3xl mx-auto border border-orange-100 mb-20 text-black"
            >
              ...
              >
                <div className="grid md:grid-cols-2 gap-6">
                  <input
                    ...
                    required
                    className="w-full border border-gray-200 bg-gray-50 text-black placeholder-gray-400 rounded-xl p-4 focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                  <input
                    type="email"
                    name="email"
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-3 px-8 rounded-xl shadow-lg shadow-orange-500/30 transition duration-300"
                  >
                    Submit Enquiry
                  </button>
                </div>
              ...
              >
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    className="bg-white px-10 py-6 rounded-2xl shadow-2xl border border-orange-100 text-center z-10"
                  >
                    <h2 className="text-3xl font-bold text-orange-600 mb-2">🎉 Enquiry Sent!</h2>
                    <p className="text-gray-800">We'll get in touch with you shortly.</p>
            ...
            <div className="relative pt-10 p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100 hover:border-purple-300 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

              <div className="relative z-10 text-center">
                <h2 className="text-2xl font-bold text-black mb-6 group-hover:text-purple-600 transition-colors duration-500">
                  Business Hours
                </h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <h3 className="text-lg font-semibold text-gray-800">Regular Days</h3>
                  ...
                  <div className="space-y-3">
                    <h3 className="text-lg font-semibold text-gray-800">Festival Season</h3>
                    <div className="space-y-2 text-gray-600">
                      <p>Extended Hours</p>
                ...
                <div className="mt-6 p-4 bg-orange-100 border border-orange-200 rounded-2xl">
              ...
              <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-gradient-to-br from-purple-500/20 to-purple-600/10 rounded-full opacity-40 group-hover:scale-150 transition-transform duration-700" />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative pt-10 p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100 hover:border-emerald-500/30 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

              <div className="relative z-10">
                <h2 className="text-2xl font-bold text-black mb-6 text-center group-hover:text-emerald-600 transition-colors duration-500">
                  Find Us on Map
                </h2>
                ...
                <div className="mt-6 text-center">
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold px-6 py-3 rounded-2xl transition-all duration-300 shadow-lg shadow-emerald-500/30 hover:shadow-xl"
                  >
              ...
              <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 rounded-full opacity-40 group-hover:scale-150 transition-transform duration-700" />
            </div>
          </motion.div>
        </section>

        <footer className="bg-gradient-to-br from-gray-50 to-orange-50 text-black py-16 border-t border-orange-100 overflow-hidden relative">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 mobile:mb-5">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              >
                ...
                <p className="text-orange-700 font-semibold mb-2">Premium Fireworks</p>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-2xl font-bold mb-6 text-orange-600">Contact Us</h2>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <MapPin className="w-5 h-5 text-orange-600 mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-black font-medium">Madhu Nisha Crackers</p>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-2xl font-bold mb-6 text-orange-600">Quick Links</h2>
