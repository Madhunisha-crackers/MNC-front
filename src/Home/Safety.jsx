      ...
      <div className="relative z-10">
        ...
        <section className="pt-32 pb-16 px-4 sm:px-6 relative overflow-hidden">
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            >
              ...
              <p className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-700 mb-6">
        ...
        <section className="py-20 px-4 sm:px-6 relative">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-black mb-6 flex items-center justify-center gap-4 mobile:flex-col mobile:gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {dosData.map(({ icon: Icon, title, description }, idx) => (
                <motion.div
                  ...
                  className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-500 border border-green-100 hover:border-green-300 overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-green-500/30 group-hover:scale-110 transition-transform duration-500">
                      <Icon className="w-8 h-8 text-white" />
                    </div>

                    <h3 className="text-xl font-bold text-black mb-4 group-hover:text-green-600 transition-colors duration-500">
                      {title}
                    </h3>
                  ...
                  <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-gradient-to-br from-green-500/20 to-green-600/10 rounded-full opacity-40 group-hover:scale-150 transition-transform duration-700" />
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 relative bg-gradient-to-br from-red-950/20 to-transparent">
          <div className="max-w-7xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-black mb-6 flex items-center justify-center gap-4 mobile:flex-col mobile:gap-2">
                <div className="w-16 h-16 bg-gradient-to-br from-red-400 to-red-600 rounded-2xl flex items-center justify-center shadow-lg shadow-red-500/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {dontsData.map(({ icon: Icon, title, description }, idx) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -8, scale: 1.02 }}
                  className="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 border border-red-100 hover:border-red-300 overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-red-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-red-400 to-red-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-red-500/30 group-hover:scale-110 transition-transform duration-500">
                      <Icon className="w-8 h-8 text-white" />
                    </div>

                    <h3 className="text-xl font-bold text-black mb-4 group-hover:text-red-600 transition-colors duration-500">
                      {title}
                    </h3>
                  ...
                  <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-gradient-to-br from-red-500/20 to-red-600/10 rounded-full opacity-40 group-hover:scale-150 transition-transform duration-700" />
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 relative">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-8 text-white text-center overflow-hidden relative shadow-2xl border border-orange-400"
            >
              ...
              <div className="relative z-10">
                ...
                <motion.div
                  ...
                  className="mt-8 p-4 bg-white/20 rounded-2xl border border-white/30"
                >
        ...
        <footer className="bg-gradient-to-br from-gray-50 to-orange-50 border-t border-orange-100 text-black py-16 shadow-lg overflow-hidden relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-black">Madhu Nisha Crackers</h2>
                </div>
                <p className="text-orange-600 font-semibold mb-2">Premium Fireworks</p>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 text-gray-700">
                    ...
                    <div>
                      <p className="text-black font-semibold">Madhu Nisha Crackers</p>
