...
const Status = () => {
  ...
  const getStatusColor = (status) => {
    switch (status?.toLowerCase()) {
      case "pending":
        return "text-yellow-300 bg-yellow-500/15 border border-yellow-500/20"
      case "confirmed":
        return "text-blue-300 bg-blue-500/15 border border-blue-500/20"
      case "packed":
        return "text-purple-300 bg-purple-500/15 border border-purple-500/20"
      case "dispatched":
        return "text-orange-300 bg-orange-500/15 border border-orange-500/20"
      case "delivered":
        return "text-green-300 bg-green-500/15 border border-green-500/20"
      case "booked":
        return "text-green-300 bg-green-500/15 border border-green-500/20"
      case "canceled":
        return "text-red-300 bg-red-500/15 border border-red-500/20"
      default:
        return "text-gray-300 bg-white/10 border border-white/10"
    }
  }
      ...
      <main className="hundred:pt-48 mobile:pt-34 px-4 sm:px-8 max-w-7xl mx-auto mobile:mb-32 hundred:mb-0">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8 mobile:-mt-20">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-black mb-4">Track Your Orders</h1>
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-gray-50 text-black placeholder-gray-500 border border-orange-200 rounded-2xl focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                />
              </div>
              <div className="relative">
              ...
              <motion.button
                ...
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-3 rounded-2xl shadow-lg shadow-orange-500/30 flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {isLoading ? (
                  <>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
                {orders.length === 0 ? (
                  ...
                  <div className="space-y-6">
                    <h2 className="text-2xl font-bold text-black mb-6">Your Orders ({orders.length})</h2>
                    {orders.map((order) => (
                      <motion.div
                            ...
                            <div className="flex items-center gap-3 mt-4 md:mt-0">
                              ...
                              <div className="flex gap-2">
                                <motion.button
                                  ...
                                  className="p-2 bg-green-50 hover:bg-green-100 text-green-700 rounded-xl border border-green-200"
                                >
                                ...
                                <motion.button
                                  ...
                                  className="p-2 bg-orange-50 hover:bg-orange-100 text-orange-600 rounded-xl border border-orange-200"
                                >
                                    ...
                                    <div key={index} className="flex items-start gap-4 pb-4 last:pb-0">
                                      <div
                                        className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${
                                          step.completed ? "bg-green-50 text-green-700 border border-green-200" : "bg-gray-100 text-gray-500 border border-gray-200"
                                        }`}
                                      >
                                        {step.icon}
                                      </div>
                                      <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between">
                                          ...
                                          {step.date && <p className="text-xs text-gray-600">{formatDate(step.date)}</p>}
                                        </div>
                                      </div>
