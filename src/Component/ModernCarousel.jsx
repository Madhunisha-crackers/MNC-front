...
const ModernCarousel = ({ media, onImageClick, isCard = false }) => {
  ...
  if (!mediaItems || mediaItems.length === 0) {
    return (
      <div className="w-full h-46 rounded-3xl mb-4 overflow-hidden bg-gradient-to-br from-orange-500 to-orange-100 flex items-center justify-center border border-orange-200">
